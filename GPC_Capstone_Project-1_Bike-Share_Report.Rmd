...
Finally, the effect of weather on ridership is examined in figure 6. As predicted, ridership tend to decrease under clearly adverse weather conditions (i.e, cold temperature and rain/snow), but appear to have been less affected by high wind speed. Member riders continue to demonstrate a more consistent behavior across the weather spectrum, while casual riders decidedly favored hot and dry days. This observation corroborate, once again, the notion that Cyclistics members use bike routinely and for more than leisure.
...
A similar analysis to the ride distance (figure 11) is carried out for the ride duration to fully describe how different rider types use Cyclistics bike differently during each ride/trip. Figure 12 shows that while casual riders rode similar distances to member riders (figure 11), they also take a significantly longer time on the bike. Once again, the patterns presented in figures 11 and 12 speak to the possible difference in use purposes between member and casual riders.
...
Given these observations, it can be safely concluded, at least for the examined period, that Cyclistics member riders used the bike-sharing service for daily commute to work, while casual riders used the service mainly for leisure/recreational purposes. Should these characteristics be also consistent with previous years and period, and given goal of encouraging users to sign up for membership, it is then reasonable to **gear the upcoming marketing campaign towards promoting the usefulness of Cyclistics' bike-sharing service in daily commuting.**

# Recommendations

Based on the insights and proposed overall direction above, three recommendations as to execution of the marketing campaign can be made:

1.  Engage in marketing/advertisement in social media platform to raise general awareness of the bike-sharing service as a practical, sustainable daily commuting options.
2.  Introduce, along with the social media push, incentives for membership signups in terms of cost, service accessibility, safety. Some examples would be:
    -   Free trial period or first-year discount
...
3.  *In the long run*, Cyclistics might consider offering its bike sharing service as a long-term and integrated commuting options:
    -   Since member riders use Cyclistics bikes to commute to work, it may be advantagous to work with local businesses/ companies to incentivise their employees signups for Cyclistics. In other words, a company can intergrate Cyclistics into the organization's employee benefit program (like the concept of renting/granting company bikes seen in Europe).

    -   Work with the city/county to integrate Cyclistics into its overall public transportation scheme. This would allow people who do not own a car to travel to the city by train or bus, then use Cyclistics bike to arrive at their workplace, all under a single, say, metro card.
